...
import no.nav.pensjon.presys.metrics.handlers.InfluxHandler;
import no.nav.pensjon.presys.metrics.handlers.SensuHandler;
...
import static no.nav.pensjon.presys.metrics.MetricsFactory.DISABLE_METRICS_REPORT_KEY;
