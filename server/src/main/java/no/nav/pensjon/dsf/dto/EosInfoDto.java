...
public class EosInfoDto {
    ...
    private int alternativBarnetrygd;
    private int alternativEktefelletillegg;
    private int antallNorskePoengaar;
    private int antallNorskePoengaarEtter1991;
    private BigDecimal sluttpoengtallEos;
    private BigDecimal overkompensasjonEos;
    private int pensjonEos;
    private String eosPar8Pkt4Ledd3BokstavA;
    private int alternativSumPensjon;
    private String nordiskKonvensjon;
    private String gunstigsteAlternativ;
    private int trygdetidEosFramtidigMaaneder;
    private int trygdetidEosAnvendtMaaneder;
    private int trygdetidEosAnvendtAAr;
    private int trygdetidNordiskFaktiskMaaneder;
    private int trygdetidNordiskFramtidigBrutto;
    private int trygdetidNordiskFramtidigNetto;
    private int pensjonsAarEos;
    private int pensjonsAarEosEtter1991;
    private int framtidigPensjonsAarEos;
    private int pensjonsAarNordiskFaktisk;
    private int pensjonsAarNordiskFramtidigBrutto;
    private int pensjonsAarNordiskFramtidigNetto;
    private BigDecimal sluttpoengtallNordiskArtikkel15;
    private BigDecimal overkompensasjonNordiskArtikkel15;
    private int grunnpensjonArtikkel13Virkedato;
