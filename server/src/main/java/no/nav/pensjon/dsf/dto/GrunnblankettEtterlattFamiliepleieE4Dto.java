...
public class GrunnblankettEtterlattFamiliepleieE4Dto extends GrunnblankettDto {
    ...
    private String fravikKonvensjon;
    private String erFlyktning;
    private int trygdetidFra1937Aar;
    private int trygdetidFra1937Maaned;
    private String trygdettidNordenAnnet;
