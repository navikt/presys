...
public class GrunnblankettBarnepensjonEnForeldreDodB6Dto extends GrunnblankettDto {

    private String beregnesEtterRedusertTrygdetid;
    private int redusertTrygdetid;
    ...
    private int vernepliktaarAvdod1;
    private int vernepliktaarAvdod2;
    private int vernepliktaarAvdod3;
    private int pensjonsgivendeInntektAvdod;
