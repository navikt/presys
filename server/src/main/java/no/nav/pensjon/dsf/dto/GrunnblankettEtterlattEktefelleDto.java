...
public class GrunnblankettEtterlattEktefelleDto extends GrunnblankettDto {

    private String bosattNorge;
    private String omsorgAvdodesBarn;
    ...
    private int bosattEktefelle;
    private String erEktefelleFlyktning;
    private int trygdetidFra1937EktefelleAar;
    private int trygdetidFra1937EktefelleMaaneder;
