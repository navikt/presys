...
public class GrunnblankettEtterlattEktefelleEpDto extends GrunnblankettDto {

    private String bosattNorge;
    private int tpProsent;
    private String omsorgAvdodeBarn;
    ...
    private int framtidigTrygdetidEktefelle;
