...
public class GrunnblankettForeldreloseBarnDto extends GrunnblankettDto {
    ...
    private String overkompensasjonUtlandMor;
    private int trygdetidFor1967Mor;
    private int trygdetidEtter1966MorAAr;
    ...
    private String overkompensasjonUtlandFar;
    private int trygdetidFor1967far;
    private int trygdetidEtter1966FarAAr;
    private int trygdetidEtter1966FarMaaneder;
    private int vernepliktaarFar1;
    private int vernepliktaarFar2;
    private int vernepliktaarFar3;
    private int vernepliktaarFar4;
    private int pensjonsgivendeInntektFar;
