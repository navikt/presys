...
public class GrunnblankettEtterlattEktefelleEeDto extends GrunnblankettDto {
    private String bosattNorge;
    private int forventetArbeidsInntekt;
    private int forventetArbeidsInntektMellom67Og70;
    ...
    private String sivilstandEktefelle;
    private int dodsdatoEktefelle;
    private String bosattNorgeEktefelle;
    private String vilkaarPar3Pkt17AEktefelle;
    private int vernepliktaar1Ektefelle;
    private int vernepliktaar2Ektefelle;
    private int vernepliktaar3Ektefelle;
    private int vernepliktaar4Ektefelle;
    private int pensjonsgivendeInntektEktefelle;
    private String redusertGrunnpensjonPar3Pkt2Ledd5;
