...
public class GrunnblankettUforepensjon2Dto extends GrunnblankettDto {

    private String attforingUfor;
    private String ektefelleTillegg;
    private String bosattNorge;
    private int antaBarnMedBarnetillegg;
    ...
    private String vilkaarPar8Pkt4Ledd3Bokatava;
    ...
    private String beregnesEtterKonvensjonbestemmelser;
    private int trygdetidAntallKonvensjonsaar;
    private int trygdetidFra1937Aar;
    private int trygdetidFra1937Maaneder;
    private String nordiskTrygdetid;
    private String fravikPar8Pkt1LeddNr3;
    private int stonadstilfelletsInntreden;
    private int inntektForUforhet;
