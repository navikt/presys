...
public class GrunnblankettEtterlattEktefelleDtoTest {
    ...
    public void thatGRUNNBE3IsMappedCorrectlyToDto() {
        ...
        assertEquals(model.getTrygdetidKonvensjonsaar(), dto.getTrygdetidKonvensjonsaar());
        ...
        assertEquals(model.getTrygdetidIAnnetNordiskLand(), dto.getTrygdetidIAnnetNordiskLand());
    ...
    public void thatGrunnblankettEtterlattEktefelleDtoIsMappedCorrectlyToJson() {
        ...
        expected.put("trygdetidKonvensjonsaar", 2222);
        ...
        expected.put("trygdetidIAnnetNordiskLand", "??");
